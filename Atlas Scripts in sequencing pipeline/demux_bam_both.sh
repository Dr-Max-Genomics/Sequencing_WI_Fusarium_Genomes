...
#SBATCH -n 60                   	   #number of logical cores
...
dorado demux --output-dir demux_bam_bothends --no-classify --barcode-both-ends --emit-summary allpod5s.bam

date
dorado demux --output-dir demux_bam_wsum --no-classify --emit-summary allpod5s.bam
