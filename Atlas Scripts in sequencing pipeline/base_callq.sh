...
#SBATCH -o "stdout.all_j.%N"          # standard output, %j adds job number to output file name and %N adds the node name
#SBATCH -e "stderr.all_j.%N"          #optional, prints standard error
...
dorado basecaller sup /project/90daydata/silage_microbiome/Max_Pod5 -r --device cuda:all --min-qscore 15 --emit-fastq > allpod5s.fastq
